...
// We need one title to which we will compare the rest. title of my desired page is    Google Account Help
...
//            Right now we do not know which handle the driver has switched to. to know it, we have to get the title of the window to which the driver has switched
